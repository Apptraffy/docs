...
sidebar_label: Шаг 3. Апи для бэкенда
---
...
Headers:
//Ключ селлера. Traffy key
SELLER_AUTH 
//Айди таска. task.company_id (из onTaskReward)
CAMPAIGN_ID 
//Айди юзера. chat_id telegram
USER_ID
//Токен который дали при награде (signedToken из onTaskReward)
REWARD_TOKEN 
